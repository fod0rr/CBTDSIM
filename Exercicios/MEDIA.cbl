      ...
      ******************************************************************
       ...
       PROGRAM-ID. CALCULAR-MEDIA. * COMEÇA COLUNA IDENTIFICATION
       AUTHOR. BERGAMASCHI, MARCELO.
       DATE-WRITTEN. 05-03-1999.
       DATE-COMPILED.
       INSTALLATION. UNISANTA - SANTOS. * TERMINA COLUNA IDENTIFICATION
       ...
       INICIO.
               ...
               STOP RUN.
           END PROGRAM CALCULAR-MEDIA. * COMPILA SÓ ATÉ A LINHA 72, A PARTIR DA 73 DA ERRO
